...
cd /Users/djp3/Development/Mac/bitcoinBuild/bitcoin
make distdir
mkdir -p win32-build
...
if [ -d "$OUT_DIR" -a -w "$OUT_DIR" ]; then
  set +e
  # Windows:
  cp /Users/djp3/Development/Mac/bitcoinBuild/bitcoin/win32-build/src/bitcoind.exe $OUT_DIR/bitcoind.exe
  cp /Users/djp3/Development/Mac/bitcoinBuild/bitcoin/win32-build/src/test/test_bitcoin.exe $OUT_DIR/test_bitcoin.exe
  cp /Users/djp3/Development/Mac/bitcoinBuild/bitcoin/win32-build/src/qt/bitcoind-qt.exe $OUT_DIR/bitcoin-qt.exe
  # Linux:
  cp /Users/djp3/Development/Mac/bitcoinBuild/bitcoin/linux-build/src/bitcoind $OUT_DIR/bitcoind
  cp /Users/djp3/Development/Mac/bitcoinBuild/bitcoin/linux-build/src/test/test_bitcoin $OUT_DIR/test_bitcoin
  cp /Users/djp3/Development/Mac/bitcoinBuild/bitcoin/linux-build/src/qt/bitcoind-qt $OUT_DIR/bitcoin-qt
  set -e
fi

# Run unit tests and blockchain-tester on Linux:
cd /Users/djp3/Development/Mac/bitcoinBuild/bitcoin/linux-build
make check

# Run RPC integration test on Linux:
/Users/djp3/Development/Mac/bitcoinBuild/bitcoin/qa/rpc-tests/wallet.sh /Users/djp3/Development/Mac/bitcoinBuild/bitcoin/linux-build/src
/Users/djp3/Development/Mac/bitcoinBuild/bitcoin/qa/rpc-tests/listtransactions.py --srcdir /Users/djp3/Development/Mac/bitcoinBuild/bitcoin/linux-build/src
/Users/djp3/Development/Mac/bitcoinBuild/bitcoin/qa/rpc-tests/forknotify.py --srcdir /Users/djp3/Development/Mac/bitcoinBuild/bitcoin/linux-build/src
# Clean up cache/ directory that the python regression tests create
rm -rf cache

if [ $RUN_EXPENSIVE_TESTS = 1 ]; then
  # Run unit tests and blockchain-tester on Windows:
  cd /Users/djp3/Development/Mac/bitcoinBuild/bitcoin/win32-build
  make check
fi
